...
#ifdef __WIN32__
# define TILP_VERSION "1.03"		// For Win32
#else
# define TILP_VERSION VERSION
#endif

#define TILP_REQUIRES_LIBCABLES_VERSION	"1.0.4"
#define TILP_REQUIRES_LIBCALCS_VERSION 	"1.0.5"
#define TILP_REQUIRES_LIBFILES_VERSION	"1.0.4"
