...
Note: the SilverLink cable may not work fine with TI82/85.
TiLP also support some virtual links: one for VirtualTI, the other one for
GtkTiEmu.

Supported calculators are: 
TI73, TI82, TI83, TI83+, TI85, TI86, TI89, TI92, TI92+ and V200.
...
TI83+:
  ...
  - sending/receiving variable
  - sending/receiving of FLASH applications
  - upgrading of Operating System (AMS) [may not work with SilverLink cable]
  - ROM dump (any shell)
  - free FLASH app signing (requires 'appsign-linux-i386-bin.zip')
