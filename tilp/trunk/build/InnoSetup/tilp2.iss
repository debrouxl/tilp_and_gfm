...
[Files]
; TI libraries
Source: "C:\lpg\tifiles2\tests\libtifiles2-11.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libtifiles2-9.dll');
Source: "C:\lpg\ticables2\tests\libticables2-8.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticables2-6.dll');
Source: "C:\lpg\ticalcs2\tests\libticalcs2-13.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticalcs2-11.dll');
Source: "C:\lpg\ticonv\tests\libticonv-9.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticonv-7.dll');
