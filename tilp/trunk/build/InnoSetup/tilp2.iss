...
;
; (c) Copyright 2001-2012, the TiLP team
;
; $Id$

[Setup]
AppName=TiLP2
AppVerName=TiLP2 1.17
...
[Files]
; TI libraries
Source: "C:\lpg\tifiles2\tests\libtifiles2-9.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libtifiles2-7.dll');
Source: "C:\lpg\ticables2\tests\libticables2-6.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticables2-4.dll');
Source: "C:\lpg\ticalcs2\tests\libticalcs2-11.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticalcs2-9.dll');
Source: "C:\lpg\ticonv\tests\libticonv-7.dll"; DestDir: "{cf}\LPG Shared\libs"; Flags: sharedfile; BeforeInstall: DeleteDll('libticonv-5.dll');
