// ScreenDump.cpp : implementation file
//
...
CScreenDump::CScreenDump(CWnd* pParent /*=NULL*/)
	: CDialog(CScreenDump::IDD, pParent)
{
	//{{AFX_DATA_INIT(CScreenDump)
	//}}AFX_DATA_INIT
}

void CScreenDump::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CScreenDump)
...
BEGIN_MESSAGE_MAP(CScreenDump, CDialog)
	//{{AFX_MSG_MAP(CScreenDump)
...
/////////////////////////////////////////////////////////////////////////////
// CScreenDump message handlers

void CScreenDump::OnCancel() 
{
...
void CScreenDump::OnScClipboard() 
{
	// TODO: Add your control notification handler code here
	
}

void CScreenDump::OnScSave() 
{
	// TODO: Add your control notification handler code here
	CString ext;
...
UINT Thread2Func(LPVOID pParam)
{
	...
	CScreenDump *pBox = (CScreenDump *)pParam;
	pBox->PostMessage(WM_USER_THREAD2_FINISHED, 0, 0);

	return 0;
}

LRESULT CScreenDump::OnThread2Finished (WPARAM wParam, LPARAM lParam)
{
...
void CScreenDump::GetScreendump()
{
	OnScRefresh();
}

void CScreenDump::OnScOptions() 
{
	// TODO: Add your control notification handler code here
	SetupScreenDlg scoptDlg;
	scoptDlg.DoModal();
}

void CScreenDump::OnPaint() 
{
