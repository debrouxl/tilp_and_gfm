...
------------
 ...
 - the GTK+ 2.x libraries
        Location: http://prdownloads.sourceforge.net/tilp/gtk-win32-runtime.zip?download
...
But, the MFC version is still provided within the package (TiLP v6.08) and takes advantages of the latest framework (libraries).
