...
int cb_send_backup(char *filename)
{
  ...
  ret = gif->user2_box(_("Warning"), 
		       _("You are going to restore the content of your calculator with a backup. The whole memory will be erased.\nAre you sure you want to do that ?"),
		       _("Next >"), 
		       _("Cancel"));
  if(ret != BUTTON1)
    return -1;
...
int cb_rom_dump(void)
{
  ...
  ret = gif->user2_box(_("Warning"), 
		       _("An assembly program is about to be sent on your calculator. If you have not made a backup yet, you should do one before proceeding with ROM dumping !"),
		       _("Next >"), 
		       _("Cancel"));
  ...
  switch(options.lp.calc_type)
    ...
    case CALC_TI83:
      ret = gif->user2_box(_("Information"), 
			   _("You must have AShell on your calculator in order to do a ROM dump. TiLP wil transfer the ROM dump program and it will wait until you launch it from the calculator."),
			   _("Next >"), 
			   _("Cancel"));
      switch(ret)
	{
    ...
    case CALC_TI85:
      ret = gif->user2_box(_("Information"), 
			   _("You must have Zshell or Usgard on your calculator in order to do a ROM dump. TiLP will transfer the ROM dump program and it will wait until you launch it from the calculator."),
			   _("Next >"), 
			   _("Cancel"));
      switch(ret)
	{
    ...
    case CALC_TI86:
      ret = gif->user2_box(_("Information"), 
			   _("You must have a shell (any) on your calculator in order to do a ROM dump. TiLP will transfer the ROM dump program and it will wait until you launch it from the calculator."),
			   _("Next >"), 
			   _("Cancel"));
      switch(ret)
	{
...
int cb_send_flash_app(char *filename)
{
  ...
  char *msg = _("You are going to send a FLASH application on your calculator.\nYou are advised to eventually turn off your screen saver, which could cause the transfer to crash.");
