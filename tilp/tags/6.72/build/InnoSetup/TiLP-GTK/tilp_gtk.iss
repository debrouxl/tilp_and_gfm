...
Name: "mfc"; Description: "Install old MFC version (6.08)"; GroupDescription: "Obsoleted:";

[Files]
; Glade files
Source: "C:\devel\tilp_project\tilp\glade\*.glade"; DestDir: "{app}\glade"; CopyMode: alwaysoverwrite;
; Help files
...
Source: "C:\devel\tilp_project\tilp\icons\COPYRIGHT"; DestDir: "{app}\icons"; DestName: "Copyright.txt"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Application.ico"; DestDir: "{app}\icons"; DestName: "App_Var.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\List.ico"; DestDir: "{app}\icons"; DestName: "Complex_List.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Matrix.ico"; DestDir: "{app}\icons"; DestName: "Complex_Matrix.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Vector.ico"; DestDir: "{app}\icons"; DestName: "Complex_Vector.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Equation.ico"; DestDir: "{app}\icons"; DestName: "Diff_Equ.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Equation.ico"; DestDir: "{app}\icons"; DestName: "Function.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Equation.ico"; DestDir: "{app}\icons"; DestName: "Parametric.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Equation.ico"; DestDir: "{app}\icons"; DestName: "Polar.ico"; CopyMode: alwaysoverwrite;
Source: "C:\devel\tilp_project\tilp\icons\Equation.ico"; DestDir: "{app}\icons"; DestName: "Y_Var.ico"; CopyMode: alwaysoverwrite;
; Pixmaps files
Source: "C:\devel\tilp_project\tilp\pixmaps\*.xpm"; DestDir: "{app}\pixmaps"; CopyMode: alwaysoverwrite;
; i18n files
;Source: "C:\devel\tilp_project\libs\files\po\fr.gmo"; DestDir: "{app}\locale\fr\LC_MESSAGES"; DestName: "tifiles.mo"; CopyMode: alwaysoverwrite;
;Source: "C:\devel\tilp_project\libs\cables\po\fr.gmo"; DestDir: "{app}\locale\fr\LC_MESSAGES"; DestName: "ticables.mo"; CopyMode: alwaysoverwrite;
;Source: "C:\devel\tilp_project\libs\calcs\po\fr.gmo"; DestDir: "{app}\locale\fr\LC_MESSAGES"; DestName: "ticalcs.mo"; CopyMode: alwaysoverwrite;
;Source: "C:\devel\tilp_project\tilp\po\fr.gmo"; DestDir: "{app}\locale\fr\LC_MESSAGES"; DestName: "tilp.mo"; CopyMode: alwaysoverwrite;

; Misc files
Source: "C:\devel\tilp_project\tilp\README.win32"; DestDir: "{app}"; DestName: "Readme_Win32.txt"; CopyMode: alwaysoverwrite
Source: "C:\devel\tilp_project\tilp\AUTHORS"; DestDir: "{app}"; DestName: "Authors.txt"; CopyMode: alwaysoverwrite
...
Source: "C:\devel\tilp_project\tilp\win32\msvc\TiLP.reg"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "C:\devel\tilp_project\tilp\registry\TiLP.registry"; DestDir: "{app}"; CopyMode: alwaysoverwrite
; TiLP/GTK
...
Source: "C:\devel\tilp_project\libs\files\tests\tifiles.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "C:\devel\tilp_project\libs\cables\tests\ticables.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "C:\devel\tilp_project\libs\calcs\tests\ticalcs.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite
Source: "C:\devel\tilp_project\tilp\win32\msvc\tilp.exe"; DestDir: "{app}"; DestName: "tilp.exe"; CopyMode: alwaysoverwrite
; TiLP/MFC
Source: "C:\devel\tilp_project\tilp-6.10\mfc\build\libintl-1.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite; Tasks: mfc;
Source: "C:\devel\tilp_project\tilp-6.10\mfc\build\iconv.dll"; DestDir: "{app}"; CopyMode: alwaysoverwrite; Tasks: mfc;
Source: "C:\devel\tilp_project\tilp-6.10\mfc\build\tilp-mfc-release.exe"; DestDir: "{app}"; DestName: "tilp-mfc.exe"; CopyMode: alwaysoverwrite; Tasks: mfc;
...
Source: "C:\devel\tilp_project\InnoSetup\AddEntry\AddEntry.exe"; DestDir: "{app}"; CopyMode: alwaysoverwrite; Attribs: hidden; MinVersion: 4,0;
...
[Icons]
Name: "{group}\TiLP (GTK)"; Filename: "{app}\tilp.exe"; WorkingDir: "{app}\My TI files"
Name: "{group}\TiLP (MFC)"; Filename: "{app}\tilp-mfc.exe"; WorkingDir: "{app}\My TI files"
