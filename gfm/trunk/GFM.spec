# GFM.spec
#
# Copyright (c) 2006 Tyler Cassidy tyler@tylerc.org
#
%define name GFM
...
Summary: Group File Manager for TI hand-helds.

%description
Group File Manager for TI hand-helds.
GFM.spec.  Generated from GFM.spec.in by configure.
Please edit GFM.spec.in to add several more lines of description
